...
const postData = [{
        ...
        content: 'MVC allows developers to maintain a true separation of concerns, devising their code between the module layer for data, the view layer for design, and the Controller layer for application logic',
        user_id: 1
